...
export function ObjectivesSection() {
  return (
    <section className="section-padding bg-background relative z-10 -mt-8 rounded-t-[2.5rem]">
          ...
          {objectives.map((obj, i) => {
            ...
            return (
              <motion.div
                ...
                className="card-objective group cursor-pointer"
              >
                ...
                <div className="flex items-center gap-2 font-sans text-[12px] font-medium text-primary group-hover:text-primary-hover transition-colors">
